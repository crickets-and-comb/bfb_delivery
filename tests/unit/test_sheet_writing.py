...
@pytest.mark.parametrize(
    ...
    [
        (nullcontext(), nullcontext(), "A1", "DRIVER SUPPORT: 555-555-5555"),
        (nullcontext(), nullcontext(), "D1", "RECIPIENT SUPPORT: 555-555-5555 x5"),
        # Mock no file.
        (
        ...
        (
            ...
            pytest.warns(UserWarning, match=" not found in config file: "),
            "A1",
            (
                "DRIVER SUPPORT: NO PHONE NUMBER. See warning in logs for instructions on "
                "setting up your config file."
...
def test_add_header_row_phone_numbers(
    ...
    expected_warning: AbstractContextManager,
    test_cell: str,
    ...
    wb = Workbook()
    ws = wb.active
    with mock_context, expected_warning:
        if ws is not None:
